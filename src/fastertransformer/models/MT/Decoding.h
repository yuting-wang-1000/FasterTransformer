...
template<typename T>
class MTDecoding: public BaseLayer {
private:
    // buffer handling
...
public:
    MTDecoding(size_t           max_batch_size,
             size_t           max_seq_len,
    ...
    MTDecoding(MTDecoding<T> const& MTDecoding);
    ...
    void forward(TensorMap* output_tensors, TensorMap* input_tensors, const MTDecodingWeight<T>* Decoding_weights);
};
